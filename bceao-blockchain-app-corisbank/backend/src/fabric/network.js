...
async function loadCredentials() {
    try {
        ...
        const certPath = path.join(
            cryptoPath,
            'peerOrganizations/corisbank.bceao.com/users/Admin@corisbank.bceao.com/msp/signcerts/Admin@corisbank.bceao.com-cert.pem'
        );
        
        const keystorePath = path.join(
            cryptoPath,
            'peerOrganizations/corisbank.bceao.com/users/Admin@corisbank.bceao.com/msp/keystore'
        );
...
async function createGrpcClient() {
    try {
        ...
        const tlsCertPath = path.join(
            cryptoPath,
            'peerOrganizations/corisbank.bceao.com/peers/peer0.corisbank.bceao.com/tls/ca.crt'
        );
        ...
        return new grpc.Client(
            ...
            tlsCredentials,
            {
                'grpc.ssl_target_name_override': 'peer0.corisbank.bceao.com',
