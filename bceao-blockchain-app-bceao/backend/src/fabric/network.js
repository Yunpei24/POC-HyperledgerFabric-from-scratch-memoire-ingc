...
async function loadCredentials() {
    try {
        ...
        const certPath = path.join(
            cryptoPath,
            'peerOrganizations/bceaoorg.bceao.com/users/Admin@bceaoorg.bceao.com/msp/signcerts/Admin@bceaoorg.bceao.com-cert.pem'
        );
        
        const keystorePath = path.join(
            cryptoPath,
            'peerOrganizations/bceaoorg.bceao.com/users/Admin@bceaoorg.bceao.com/msp/keystore'
        );
...
async function createGrpcClient() {
    try {
        ...
        const tlsCertPath = path.join(
            cryptoPath,
            'peerOrganizations/bceaoorg.bceao.com/peers/peer0.bceaoorg.bceao.com/tls/ca.crt'
        );
        ...
        return new grpc.Client(
            ...
            tlsCredentials,
            {
                'grpc.ssl_target_name_override': 'peer0.bceaoorg.bceao.com',
